...
export const fetchGame = createAsyncThunk("games/fetchGame", async () => {
  try {
    const response = await axios.get(
      "https://7878-27-50-29-117.ngrok-free.app/games"
    );
...
export const fetchArcadeDetail = createAsyncThunk(
  ...
  async (id) => {
    try {
      const response = await axios.get(
        `https://7878-27-50-29-117.ngrok-free.app/detail/${id}`
      );
...
export const fetchBrand = createAsyncThunk("games/fetchBrand", async () => {
  try {
    const response = await axios.get(
      "https://7878-27-50-29-117.ngrok-free.app/brands"
    );
  ...
  async (credentials) => {
    try {
      const response = await axios.post(
        `https://7878-27-50-29-117.ngrok-free.app/users/login`,
        credentials
      );
